...
@register_model
def vit_re_base_patch16(pretrained=False, pretrain_type='default',
...
@register_model
def vit_re_large_patch16(pretrained=False, pretrain_type='default',
                              search_size=384, template_size=192, **kwargs):
    patch_size = 16
    model = VisionTransformer(
        search_size=search_size, template_size=template_size,
...
@register_model
def vit_re_huge_patch14(pretrained=False, pretrain_type='default',
