"""
vit_4t:把模板拷贝为4份送入网络，来验证大模板区域是否是容量带来的提升
"""
...
@register_model
def vit_t4_base_patch16(pretrained=False, pretrain_type='default',
...
@register_model
def vit_t4_large_patch16(pretrained=False, pretrain_type='default',
                              search_size=384, template_size=192, **kwargs):
    patch_size = 16
    model = VisionTransformer(
        search_size=search_size, template_size=template_size,
...
@register_model
def vit_t4_huge_patch16(pretrained=False, pretrain_type='default',
